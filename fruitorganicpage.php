...
<head>
    ...
    <link rel="stylesheet" href="fruitorganic.css">
...
<body>
    ...
    <div class="contant_mainpage">
        <div class="table_item_product">
            ...
            //connect db
            include("server.php");
            $sql = "SELECT * FROM tbl_product where fruittype = '2' ";  //เรียกข้อมูลมาแสดงทั้งหมด
            ...
            ?>
                <div class="box_contant">
                    <div class="item_product_organic">
                        <div class="head_organic">
                            <p>ORGANIC</p>
                        </div>
                        <div class="item_product_picture_organic">
